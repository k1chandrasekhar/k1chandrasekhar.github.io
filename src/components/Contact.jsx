  ...
  return (
    <section className="section" id="contact">
      <div className="container">
        ...
        <div className={`${styles.wrapper} reveal reveal-2`}>
          {/* Left: photo + personal note */}
          <div className={styles.personalSide}>
            ...
            <p className={styles.note}>
              Open to backend and cloud engineering roles, consulting, and collaboration.
              Always happy to talk about distributed systems and infrastructure.
            </p>
          </div>
